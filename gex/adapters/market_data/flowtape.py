...
from gex.infrastructure.config import CONTRACT_MULTIPLIER
from gex.adapters.market_data.rtquote import (
    BACKOFF_MAX,
    BACKOFF_START,
    QUOTES,
    credentials_present,
...
def multiplier_of(symbol: str) -> float:
    ...
    """
    from gex.adapters.market_data.futopt import _multiplier_cache
...
def build_future_universe(code: str, spot: float, access_token: str,
    ...
    from gex.adapters.market_data.futopt import fetch_chain_instruments, filter_chain, PRODUCT_PARAMS
...
class FlowTape:
    ...
    def _build_universe(self) -> dict[str, str]:
        ...
        """
        from gex.adapters.market_data import futopt, idxopt
